...
var excludedFolders = [
  path.resolve(__dirname, '../../platforms/android/assets/www/lib/ionic/fonts'),
  path.resolve(__dirname, '../../platforms/ios/assets/www/lib/ionic/fonts')
];


var deleteFolderRecursive = function(removePath) {
  if( fs.existsSync(removePath) && excludedFolders.indexOf(removePath) == -1 ) {
    ...
    fs.readdirSync(removePath).forEach(function(){
      isEmpty = false;
    });
