angular.module('starter.controllers')
  .controller('MapCtrl', function($rootScope, $scope, $timeout, $log, $window, $state,
                                  ...
                                  Ref, GeofireRef, GeoFire, _, catalogs, appConfig, appModals,
    ...
    self.showRatingHistory = showRatingHistory;
    self.showScoreDetail = showScoreDetail;
    ...
    function submitStationRating(form) {
      ...
      if (form.$valid) {
        ...
        if (user) {
          ...
          ratingFanout[getTodayRatingPath(user.uid) + '/' + self.newStationRating.ratingNumber] = rating;
          ...
          Ref.update(ratingFanout, function(error) {
              ...
              Ref.child('stations/' + self.newStationRating.stationId + '/private' + '/rating')
                .transaction(function(currentRating) {
                    ...
                    if (error || !committed) {
                      ...
                      $cordovaToast.showShortCenter('Tu calificación ha sido guardada y será procesada más tarde');
                    }
                    else {
    ...
    function showRatingHistory() {
      ...
      appModals.showRatingHistory(self.selectedStation);
    }
